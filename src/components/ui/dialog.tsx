  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-card p-5 text-card-foreground shadow-lg outline-none",
          className,
        )}
        {...props}
      >
        ...
        <DialogPrimitive.Close
          className="absolute top-4 right-4 rounded-md opacity-70 outline-none hover:opacity-100"
